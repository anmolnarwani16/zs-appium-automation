...
public final class PlacingOrderTest extends MobileBaseTest {
    ...
    public void placeOrderTest(Map<String, String> data) {
        try {
            ...
            //new HomePage().clickOnCategory(Constant.PLACE_ORDER, Constant.CATEGORY_MEAT);
            ...
            //new SearchPage().clickOnItem(Constant.PLACE_ORDER,Constant.AUSTRALIAN_ORGANIC_BEEF);
            new CheckoutPage().addItemToCartAndCheckLimit(Constant.PLACE_ORDER);
            new HomePage().clickBackToHome(Constant.PLACE_ORDER);
            ...
            new CheckoutPage().enterComment(MobileDriverManager.getDriver(), Constant.PLACE_ORDER);
            //.clickDebitCardButton(Constant.PLACE_ORDER).clickOnSavedDebitCard(Constant.PLACE_ORDER).clickOnPlaceOrderButton(Constant.PLACE_ORDER);
            new CheckoutPage().clickCashOnCollectionButton(Constant.PLACE_ORDER).clickOnPlaceOrderButton(Constant.PLACE_ORDER);
