...
public class SignInSignOutTest extends MobileBaseTest {
    ...
    public void signinSignoutTest(Map<String,String> data){
        ...
        String loggedInUser = new HomePage().clickOnHamburgerIcon(Constant.SIGNINSIGNOUT_TEST).getUserName(Constant.SIGNINSIGNOUT_TEST);
        ...
        String signUpHeading = new SignInPage().getHeading(Constant.SIGNINSIGNOUT_TEST);
